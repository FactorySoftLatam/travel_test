...
namespace TravelLibrary.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<TravelLibrary.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<TravelLibrary.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(TravelLibrary.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(TravelLibrary.Server.Models.ApplicationUser user)
        {
            try
            {
