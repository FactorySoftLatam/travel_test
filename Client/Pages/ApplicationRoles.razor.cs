...
namespace TravelLibrary.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<TravelLibrary.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(TravelLibrary.Server.Models.ApplicationRole role)
        {
            try
            {
