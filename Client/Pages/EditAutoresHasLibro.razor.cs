...
{
    public partial class EditAutoresHasLibro
    {
        [Inject]
        ...
        {
            autoresHasLibro = await dbTravelLIBService.GetAutoresHasLibroByAutoresIdAndLibrosIsbn(autoresId:autores_id, librosIsbn:libros_ISBN);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await dbTravelLIBService.UpdateAutoresHasLibro(autoresId:autores_id, librosIsbn:libros_ISBN, autoresHasLibro);
